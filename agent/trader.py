...
_SCHEDULE_SLOTS = [
    ...
    (dtime(9, 37),  "【2회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(9, 54),  "【3회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 11), "【4회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 28), "【5회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 45), "【6회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(11, 2),  "【7회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(11, 19), "【8회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(11, 36), "【9회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(11, 53), "【10회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(12, 10), "【11회차 — 점심 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(12, 27), "【12회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(12, 44), "【13회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 1),  "【14회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 18), "【15회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 35), "【16회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 52), "【17회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(14, 9),  "【18회차 — 후반 점검】TP/SL 확인. 강한상승 2봉+ 연속일 때만 진입. 당일 청산 고려."),
    (dtime(14, 26), "【19회차 — 후반 점검】TP/SL 확인. 강한상승 2봉+ 연속일 때만 진입. 당일 청산 고려."),
