...
_SCHEDULE_SLOTS = [
    (dtime(9, 40),  "【1회차 — 진입】장 시작 40분 경과. Google 검색 후 Top10 스캔, HA 신호 강한 종목 적극 매수."),
    (dtime(9, 57),  "【2회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 14), "【3회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 31), "【4회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(10, 48), "【5회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(11, 5),  "【6회차 — 오전 점검】TP/SL 먼저 확인. HA 강/중 진입 가능."),
    (dtime(11, 22), "【7회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(11, 39), "【8회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(11, 56), "【9회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(12, 13), "【10회차 — 오전 후반 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(12, 30), "【11회차 — 점심 점검】TP/SL 확인. HA 강 우선, 중은 선택적 진입."),
    (dtime(12, 47), "【12회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 4),  "【13회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 21), "【14회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 38), "【15회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(13, 55), "【16회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(14, 12), "【17회차 — 오후 점검】TP/SL 확인. HA 강(강한상승 1봉+)만 허용."),
    (dtime(14, 29), "【18회차 — 후반 점검】TP/SL 확인. 강한상승 2봉+ 연속일 때만 진입. 당일 청산 고려."),
    (dtime(14, 46), "【19회차 — 후반 점검】TP/SL 확인. 강한상승 2봉+ 연속일 때만 진입. 당일 청산 고려."),
    (dtime(15, 10), "【20회차 — 강제 청산】신규 매수 절대 금지. 보유 전종목 즉시 전량 매도."),
]
