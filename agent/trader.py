...
_SCHEDULE_SLOTS = [
    ...
    (dtime(10, 2),  "【7회차 — 진입 마감 임박】TP/SL 먼저 확인. 신규 진입 기준 상향: VWAP +0.8% 이상 + HA 강한상승 필수. 이 회차 이후 신규 진입 원칙적 금지."),
    (dtime(10, 9),  "【8회차 — 진입 마감】TP/SL 먼저 확인. 신규 진입 기준 상향: VWAP +0.8% 이상 + HA 강한상승 필수. 이 회차 이후 신규 진입 금지."),
    (dtime(10, 16), "【9회차 — 신규 진입 금지】TP/SL 확인. 보유 종목 관리에만 집중. 신규 매수 없음."),
    (dtime(10, 23), "【10회차 — 신규 진입 금지】TP/SL 확인. 보유 종목 관리에만 집중. 신규 매수 없음."),
